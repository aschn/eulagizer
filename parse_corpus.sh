...
./parse_corpus_file.py corpus_raw/american_air.txt corpus/american_air.txt AAdvantage aa.com 'American Airlines'
./parse_corpus_file.py corpus_raw/apple.txt corpus/apple.txt Apple apple.com 'Apple Inc.'
./parse_corpus_file.py corpus_raw/chrome.txt corpus/chrome.txt Chrome google.com Google
